...
class Data:
    ...
    def plot_result(self, lin_estimate_a, lin_estimate_b, quad_estimate_a, quad_estimate_b, quad_estimate_c):
        ...
        ax.scatter(np.array(self.points)[:, 0], np.array(self.points)[:, 1], s=1, c='b', marker='o', label='fitted data')
        ax.scatter(np.array(self.test_points)[:, 0], np.array(self.test_points)[:, 1], s=1, c='k', marker='o', label='test data')
